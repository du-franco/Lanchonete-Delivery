...
public abstract class Massa extends Lanche {
	...
	/**
	 * Método onde o usuário escolhe o tipo da massa
	 */
	public static void escolherTipoDeMassa() {
		...
		System.out.println(
				"__________________________________Menu de opções____________________________________________________________");
	...
	/**
	 * 
	 * Método onde o usuário escolhe o tipo do molho
	 */
	public String escolherMolho() {
		...
		System.out.println(
				"____________________________________________Menu de opções____________________________________________________________");
